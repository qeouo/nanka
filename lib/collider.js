...
//ここから基本図形-----------------------------------------------------
	...
	var ConvexHull = ret.ConvexHull= (function(){
		...
		ret.prototype.ray= function(p0,p1){
			return Collider.CONVEX_HULL_ray(p0,p1,this,null);
//			
//			var t=Vec3.poolAlloc();
//			var axis=Vec3.poolAlloc();
//			var v=[];
...
var TRIANGLE_TRIANGLE=function(ans1,ans2,t1,t2,t3,t4,t5,t6){
	...
	ret.CONVEX_HULL_ray= function(p0,p1,o1,o2){
		var t=Vec3.poolAlloc();
		var axis=Vec3.poolAlloc();
		...
		//最初の点を求める
		o1.calcSupport(v1[0],axis);
		if(o2){
			Vec3.mul(_axis,axis,-1);
			o2.calcSupport(v2[0],_axis);
		}
		...
		while(1){
			//axisの向きで一番近い点をとる
			o1.calcSupport(v1[idx],axis);
			if(o2){
				Vec3.mul(_axis,axis,-1);
				o2.calcSupport(v2[idx],_axis);
			}
	...
	ret.convexCast=function(ang,o1,o2){
		var p0=new Vec3(0,0,0);
		return this.CONVEX_HULL_ray(p0,ang,o2,o1);
	}
	return ret;
})();
