...
//ここから基本図形-----------------------------------------------------
	...
	class Sphere extends Collision{
		//球
		constructor(){
			super()
			this.type=SPHERE;
		...
		rayCast(p0,p1,normal) {
			...
			var l =SPHERE_LINE(p0,p1,p,this.bold,normal);
			Vec3.poolFree(1);
			return l;
		}
	};
	...
	class Cylinder extends Collision{
		//シリンダ
		constructor(){
			super();
			this.type=CYLINDER;
	...
	class Capsule extends Collision{
		//カプセル
		constructor(){
			super();
			this.type=CAPSULE;
		...
		rayCast(p0,p1,normal) {
			...
			l = SPHERE_LINE(p0,p1,p,this.bold,n2);
	...
	class Cuboid  extends Collision{
		//直方体
		constructor(){
			super();
			this.type=CUBOID;
	...
	sphere.bold=0;
	class ConvexHull extends Collision{
		//凸包
		constructor(){
			super();
	...
	class Triangle extends ConvexHull{
		constructor(){
			super();
...
//----------------------------------------------------------------------------------------
	...
	var SPHERE_LINE = function(p0,p1,p2,r,normal) {
		var p = Vec3.poolAlloc();
		var d = Vec3.poolAlloc();
		Vec3.sub(p,p0,p2);
		Vec3.sub(d,p1,p0);
