...
var Collider = (function(){
	...
	var Sphere = ret.Sphere = (function(){
		...
		var p=new Vec3();
		ret.prototype.ray = function(p0,p1) {
			Vec3.set(p,this.matrix[12],this.matrix[13],this.matrix[14]);
	...
	var Cylinder= ret.Cylinder= (function(){
		...
		ret.prototype.ray= function(p0,p1) {
			...
			var d = bV0;
			var p = bV1;
			Mat44.dotVec3(p,this.inv_matrix,p0);
			Mat44.dotVec3(d,this.inv_matrix,p1);
			Vec3.sub(d,d,p);
	...
	var Cone= ret.Cone= (function(){
		...
		var v2=new Vec3();
		ret.prototype.calcSupport=function(ans,v){
			Mat44.dotMat33Vec3(v2,this.inv_matrix,v);
			Vec3.norm(v2);
			...
			Mat44.dotVec3(ans,this.matrix,ans);
		};
