...
var createShader = function(){
	...
	mainArgs["lightMat"]=(gl.getUniformLocation(program,"lightMat"));
	...
	mainArgs["uShadowmap"]=gl.getUniformLocation(program,"uShadowmap");
...
//				texture=renderface.texture.gltexture;
		...
		if(tex){
			...
			gl.uniform1i(mainArgs["uShadowmap"],1);
...
var stereofunc=function(func,ono3d){
