...
var useProgram = ret.useProgram = function(shader,elementNum){
	gl.useProgram(shader.program);

	for(var i=0;i<shader.attributes.length;i++){
		var arg=shader.attributes[i].arg;
		gl.vertexAttribPointer(arg.att, arg.size,arg.type, false, 0, arg.offset2*4*elementNum);
	}
}
