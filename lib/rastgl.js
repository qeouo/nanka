...
ret.init=function(_gl){
	...
	var loadjs=[
		//"mainshader2"
		"shadow","gauss","normalmap","environment","plainshader","add"
	];
	...
	ret.commonFunction=" \n \
		vec4 encode(vec4 src){ \n \
			...
			float idx = ceil(log2(m+0.01)); \n \
			return vec4(src.rgb / exp2(idx),(idx+127.0)/255.0); \n \
		} \n \
	...
	";
	 ...
	 ret.postEffect =function(src,u,v,w,h,sh){
		...
		gl.uniform2f(unis["uUvScale"],w,h);
		gl.uniform2f(unis["uUvOffset"],u,v);
