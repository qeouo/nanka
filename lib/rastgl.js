...
ret.init=function(_gl){
	...
	ret.commonFunction=" \n \
		...
		vec4 unpackFloat(vec4 src){ \n \
			vec3 rgb; \n \
			rgb.r = src.r * sign(1.0-floor(src.a*2.0)*2.0); \n \
			rgb.g = src.g * sign(1.0-floor(src.a*4.0)*2.0); \n \
			rgb.b = src.b * sign(1.0-floor(src.a*8.0)*2.0); \n \
			float idx = floor(fract(src.a*8.0) * 32.0 - 16.0); \n \
			return vec4(rgb.rgb * exp2(idx),1.0); \n \
		} \n \
