...
var stereoDraw=ret.stereoDraw = function(ono3d,func){
	...
	if(globalParam.stereomode==0){
		...
		ono3d.setPers(ono3d.aov,HEIGHT/WIDTH);
		ono3d.projectionMatrix[8]=0;//stereo/10;
		ono3d.projectionMatrix[12]=stereo;
		Mat44.dot(ono3d.pvMatrix,ono3d.projectionMatrix,ono3d.viewMatrix);
		func();

		ono3d.projectionMatrix[12]*=-1;
		Mat44.dot(ono3d.pvMatrix,ono3d.projectionMatrix,ono3d.viewMatrix);
...
var initAtts2= ret.initAtts2 = function(shader,uniforms){
	_offset=0;
...
var useProgram = ret.useProgram = function(shader){
