...
ret.init=function(_gl){
	...
	ret.commonFunction=" \n \
		...
		lowp vec2 encodeShadow(highp float ff){ \n \
			highp vec2 color; \n \
 ...
 \n \
		...
		highp vec2 decodeFull_(highp vec4 src){ \n \
			//return (src.r*256.0*256.0  + src.g*256.0 + src.b)/65535.0; \n \
			return vec2(src.r*256.0  + src.g,src.b *256.0 + src.a)/256.0; \n \
		} \n \
