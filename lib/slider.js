...
//		div.appendChild(lbl);
		...
		document.addEventListener("pointerup",function(evt){dragging=false;},false);
		document.addEventListener("pointermove",function(evt){if(dragging){drag(evt);}},false);
		input.addEventListener("touchmove",function(evt){ evt.preventDefault();},false);
		input.addEventListener("pointerdown",function(evt){dragging=true;},false);
		slider.addEventListener("click",drag,false);
		output.addEventListener("input",function(evt){setValue(evt.target.value);},false);
