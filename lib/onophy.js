...
var OnoPhy = (function(){
	...
	var act = function(obj,p,f,obj2){
		...
		//ダンパ
		Vec3.mul(a_fric,a_n,Vec3.dot(a_n,obj.v)*-obj.damper);
...
//			Vec3.muladd(obj.aa,obj.aa,a_a,l2*-obj.adamper);
		...
		Vec3.muladd(mem,obj.v,obj.a,1/obj.mass/60);
		Vec3.muladd(mem2,obj.av,obj.aa,1/obj.imoment/60);

		Vec3.cross(a_a,mem2,a_l);
		Vec3.muladd(mem2,a_a,a_n,-Vec3.dot(a_n,a_a));
		Vec3.muladd(mem,mem,a_n,-Vec3.dot(a_n,mem));
		Vec3.add(a_a,mem2,mem);

		if(obj.name=="tes"){
			console.log(mem,mem2);
		}


		var a = Vec3.dot(a_n,a_l);
		var ff = obj.mass/(1-obj.mass*a*a/obj.imoment)
		Vec3.mul(a_fric,a_a,ff*60);
		...
		Vec3.cross(a_a,a_l,a_fric);
		//Vec3.muladd(a_a,a_a,a_n,-Vec3.dot(a_n,a_a));
		//Vec3.mul(a_a,a_a,1/Vec3.scalar(a_l));
		Vec3.add(obj.aa,obj.aa,a_a);
