...
var OnoPhy = (function(){
	...
	var RigidBody = (function(){
		var RigidBody = function(){
			...
			this.moveflg=1;
			this.matrix =new Mat44(); //オブジェクトの姿勢等
		...
		ret.prototype.getExPos = function(a,b){
			Mat44.dotMat44Vec3(a,this.inv_matrix,b);
		}
	...
	var Joint = (function(){
		...
		ret.prototype.setConstraint=function(){
			...
			if(object1 === this.parent){
				Vec3.set(obj1p,bM[12],bM[13],bM[14]);
				Vec3.copy(obj2p,object2.location);
			}else{
				Vec3.copy(obj1p,object1.location);
				Vec3.set(obj2p,bM[12],bM[13],bM[14]);
			}
	...
	var Spring =  (function(){
		...
		ret.prototype.calc =function(){
			...
			//接続点
			if(this.con1){
				Mat44.dotMat44Vec3(this.p0,this.con1.matrix,this.con1Pos);
				this.con1.calcVelocity(dp,this.p0);
			}else{
				Vec3.sub(dp,this.p0,this._p0);
			}
			if(this.con2){
				Mat44.dotMat44Vec3(this.p1,this.con2.matrix,this.con2Pos);
	...
	ret.prototype.calc=function(dt){
		...
		for(var i=0;i<this.hitInfos.length;i++){
			...
			var l,l2;
			Mat44.dotMat44Vec3(ans1,obj1.matrix,hitInfo.pos1ex);
			...
			Mat44.dotMat44Vec3(ans4,obj2.matrix,hitInfo.pos2ex);
