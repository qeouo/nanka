...
var OnoPhy = (function(){
	...
	var HitInfo = (function(){
		...
		ret.prototype.calcPre = function(){
			...
			if(this.counter==0 || 1){
				...
				if(Vec3.scalar(this.offset)>0.01){
					Vec3.nrm(dv,this.offset);
					Vec3.muladd(this.offset,this.offset,dv,0.01);
			...
			//前回値補正
			Vec3.set(dv,0,0,0);
			Vec3.muladd(dv,dv,this.nVec,Vec3.dot(this.nVec,this.impulse));
			Vec3.copy(this.impulse,dv);
	...
	var Joint = (function(){
		...
		ret.prototype.calcPre=function(){
			...
			Vec3.mul(this.linConstraint.offset,this.truepos,PENALTY*_dt);
