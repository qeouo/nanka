...
var OnoPhy = (function(){
	...
	var springMove=function(obj){
		//接続点
		if(obj.con1){
			Mat43.dotMat43Vec3(bV0,obj.con1.matrix,obj.con1Pos);
		}else{
			Vec3.copy(bV0,obj.con1Pos);
		}
		if(obj.con2){
			Mat43.dotMat43Vec3(bV1,obj.con2.matrix,obj.con2Pos);
		}else{
			Vec3.copy(bV1,obj.con2Pos);
		}
		...
		Vec3.norm(bV2);
		Vec3.mul(bV2,bV2,l*40);

		if(obj.con1){
			impact(obj.con1,bV0,bV2);
		}
		if(obj.con2){
			Vec3.mul(bV2,bV2,-1);
			impact(obj.con1,bV1,bV2);
		}
