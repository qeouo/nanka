...
//			Vec3.mul(bV2,bV2,PENALTY);
	...
	var CUBOID_CUBOID=function(boxA,boxB,dt){
		...
		Mat43.dotMat33Vec3(bV1,matB,boxB.size);
		bV2[0] = matA[0]*boxA.size[0];
		bV2[1] = matA[1]*boxA.size[0];
		bV2[2] = matA[2]*boxA.size[0];
		var l = cuboidsub(bV2,bV1);
		var l2 = bV0[0] * bV2[0] + bV0[1]*bV2[1] + bV0[2]*bV2[2];

		if(l2 * l2 > l*l){
			return;
		}

		bV2[0] = matA[4]*boxA.size[1];
		bV2[1] = matA[5]*boxA.size[1];
		bV2[2] = matA[6]*boxA.size[1];
		l = cuboidsub(bV2,bV1);
		l2 = bV0[0] * bV2[0] + bV0[1]*bV2[1] + bV0[2]*bV2[2];

		if(l2 * l2 > l*l){
			return;
		}

		bV2[0] = matA[8]*boxA.size[2];
		bV2[1] = matA[9]*boxA.size[2];
		bV2[2] = matA[10]*boxA.size[2];
		l = cuboidsub(bV2,bV1);
		l2 = bV0[0] * bV2[0] + bV0[1]*bV2[1] + bV0[2]*bV2[2];
		if(l2 * l2 > l*l){
			return
		...
		Mat43.dotMat33Vec3(bV1,matA,boxA.size);
		bV2[0] = matB[0]*boxB.size[0];
		bV2[1] = matB[1]*boxB.size[0];
		bV2[2] = matB[2]*boxB.size[0];
		l = cuboidsub(bV2,bV1);
		l2 = bV0[0] * bV2[0] + bV0[1]*bV2[1] + bV0[2]*bV2[2];
		...
		bV2[0] = matB[4]*boxB.size[1];
		bV2[1] = matB[5]*boxB.size[1];
		bV2[2] = matB[6]*boxB.size[1];
		l = cuboidsub(bV2,bV1);
		l2 = bV0[0] * bV2[0] + bV0[1]*bV2[1] + bV0[2]*bV2[2];
		if(l2 * l2 > l*l){
			return
		...
		bV2[0] = matB[8]*boxB.size[2];
		bV2[1] = matB[9]*boxB.size[2];
		bV2[2] = matB[10]*boxB.size[2];
		l = cuboidsub(bV2,bV1);
		l2 = bV0[0] * bV2[0] + bV0[1]*bV2[1] + bV0[2]*bV2[2];
		if(l2 * l2 > l*l){
			return
