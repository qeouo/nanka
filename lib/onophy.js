...
var OnoPhy = (function(){
	...
	var act = function(obj,p,f,obj2){
		...
		Vec3.cross(a_ma,a_fn,a_n);
		Vec3.add(obj.aa,obj.aa,a_ma);
		...
		Vec3.sub(a_d,p,obj.location);
		Vec3.cross(a_ma2,obj.av,a_d);
		Vec3.add(a_ma,a_ma,a_ma2);
		//Vec3.add(obj.aa,obj.aa,a_ma);
		//if(a_ma[0]*a_ma[0]+a_ma[1]*a_ma[1]+a_ma[2]*a_ma[2]<0.0000001){
		if(0){
			var friction = 2*obj.sfriction*obj2.sfriction/(obj.sfriction+obj2.sfriction);
		}else{
			Vec3.sub(a_d,p,obj.location);
			Vec3.cross(a_fn,obj.av,p);

			Vec3.norm(a_ma);
			var dfriction = 2*obj.dfriction*obj2.dfriction/(obj.dfriction+obj2.dfriction);
			Vec3.mul(a_n,a_ma,-n*dfriction);
