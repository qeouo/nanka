...
var OnoPhy = (function(){
	...
	var ClothHitInfo= (function(){
		...
		ret.prototype.calcPre=function(){
			...
			Mat33.set(this.rM,0,0,0,0,0,0,0,0,0);
			HitInfo.prototype.calcPre.call(this);
		...
		ret.prototype.addImpulse = function(_impulse){
			...
			Vec3.muladd(this.face.point1.v
				,this.face.point1.v,impulse,this.ratio[0]*this.obj2.inv_mass);
			Vec3.muladd(this.face.point2.v
				,this.face.point2.v,impulse,this.ratio[1]*this.obj2.inv_mass);
			Vec3.muladd(this.face.point3.v
				,this.face.point3.v,impulse,this.ratio[2]*this.obj2.inv_mass);
		...
		ret.prototype.calcEfficM= (function(){
			...
			return function(m){
				...
				var r = Vec3.scalar2(this.ratio)*this.obj2.inv_mass;
				m[0]=m[4]=m[8]=r;
