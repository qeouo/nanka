	...
	var Cloth = ret.Cloth = (function(){
		...
		var PhyFace = ret.PhyFace = (function(){
			...
			ret.prototype.calcVelocity = function(dv){
				Vec3.mul(dv,this.face.point1.v,this.ratio[0]);
				Vec3.muladd(dv,dv,this.face.point2.v,this.ratio[1]);
				Vec3.muladd(dv,dv,this.face.point3.v,this.ratio[2]);
			}

			ret.prototype.addImpulse = function(pos,impulse){
				Vec3.muladd(this.face.point1.v
					,this.face.point1.v,impulse,this.ratio[0]*this.face.cloth.inv_mass);
				Vec3.muladd(this.face.point2.v
					,this.face.point2.v,impulse,this.ratio[1]*this.face.cloth.inv_mass);
				Vec3.muladd(this.face.point3.v
					,this.face.point3.v,impulse,this.ratio[2]*this.face.cloth.inv_mass);
			}
			ret.prototype.calcEfficM= (function(){
				return function(m){
					var r = Vec3.scalar2(this.ratio)*this.face.cloth.inv_mass;
					m[0]=m[4]=m[8]=r;
			...
			for(var i=0;i<list.length;i++){
				...
				for(var j=0;j<this.faces.length;j++){
					...
					if(l<0){
						...
						Vec3.sub(v1,obj2.face.point2.location,obj2.face.point1.location);
						Vec3.sub(v2,obj2.face.point3.location,obj2.face.point1.location);
						Vec3.cross(v1,v1,v2);
						var p=[obj2.face.point1.location
							,obj2.face.point2.location
							,obj2.face.point3.location
							,obj2.face.point1.location
							,obj2.face.point2.location];
