...
//			Vec3.add(ans,ans,this.location);
	...
	var registHitInfo = function(obj,p,obj2,p2){
				...
				for(var k=0;k<mesh.faces.length;k++){
					...
					for(var j=0;j<faces.length;j++){
						...
						if(l<(springmesh.bold+collision.bold) && l!=0){
							...
							Vec3.muladd(accs[face[0]],accs[face[0]],springmesh.v[face[0]],-2);
							Vec3.add(accs[face[1]],accs[face[1]],n);
							Vec3.muladd(accs[face[1]],accs[face[1]],springmesh.v[face[1]],-2);
							Vec3.add(accs[face[2]],accs[face[2]],n);
							Vec3.muladd(accs[face[2]],accs[face[2]],springmesh.v[face[2]],-2);
