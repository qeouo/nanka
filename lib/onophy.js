			...
			for(var i=0;i<this.faces.length;i++){
				...
				for(var j=0;j<target.faces.length;j++){
					...
					for(var fan=0;fan<(face.idxnum-2);fan++){
						triangle.v[0]=face.points[0].location;
						triangle.v[1]=face.points[1+fan].location;
						triangle.v[2]=face.points[2+fan].location;

						for(var fan2=0;fan2<(face2.idxnum-2);fan2++){
							triangle2.v[0]=face2.points[0].location;
							triangle2.v[1]=face2.points[1+fan2].location;
							triangle2.v[2]=face2.points[2+fan2].location;
				...
				if(min<0){
					var face = this.faces[trueidx1];
					var face2 = target.faces[trueidx2];
