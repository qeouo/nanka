...
//			friction = 2*obj.dfriction*obj2.dfriction/(obj.dfriction+obj2.dfriction);
	...
	var calc_t=function(phyObjs,dt){
		...
		for(i = phyObjs.length;i--;){
			...
			Vec3.muladd(obj.a,obj.a,obj.v,-0)
