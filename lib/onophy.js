...
var OnoPhy = (function(){
	...
	var springmeshMove=function(mesh){
		...
		for(var j=pos.length;j--;){
			...
			Vec3.muladd(accs[j],accs[j],velocities[j],-mesh.friction/60);
...
//			}
			...
			Vec3.mul(bV0,bV3,(Vec3.dot(bV1,bV3))/60);
	...
	var springmeshMove2=function(mesh,dt){
		...
		//		Vec3.muladd(positions[j],positions[j],bV3,goal);
				Vec3.mul(bV3,bV3,mesh.goalSpring*40);
				Vec3.muladd(bV3,bV3,bV2,-Vec3.dot(bV2,velocity)*mesh.goalFriction/10.0);
