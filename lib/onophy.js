...
var OnoPhy = (function(){
	...
	var Cloth = ret.Cloth = (function(){
		...
		var  Edge = (function(){
			...
			ret.prototype.calcPre=function(m){
				Vec3.sub(dv,this.point2.p,this.point1.p);
				var l = Vec3.scalar(dv);
				this.offset = (this.len - l)*0.2;
				Vec3.nrm(this.n,dv);
				Vec3.mul(this.impulse,this.n,this.impulse);

				this.point1.v+=impulse/m;
				this.point2.v-=impulse/m;
			...
			ret.prototype.calc=function(m){
				...
				this.impulse += (Vec3.dot(dv,this.n)+this.offset)*m*2;


				Vec3.mul(impulse,this.n,(this.impulse-old)/(m*2));

				Vec3.add(this.point1.v,this.point1.v,impulse);
				Vec3.sub(this.point1.v,this.point2.v,impulse);
			}
			return ret;
		})();
		var Face = (function(){
			...
			ret.prototype.calcPre=function(dt){
				Vec3.muladd(this.location,this.location,this.v,dt);
	...
	ret.prototype.calc=function(dt){
		...
		var springMeshes = this.springMeshes;
		for(i = springMeshes.length;i--;){
			//バネメッシュ処理
