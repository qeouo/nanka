...
var OnoPhy = (function(){
	...
	var HitInfo = (function(){
		...
		ret.prototype.calcPre = function(){
			...
			//加速に必要な力を求めるための行列
			Constraint.calcEfficM(nM,obj1,this.pos1,obj2,this.pos2);
			Constraint.calcEffic(this.nV,nM,this.nVec);
			Constraint.calcEffic2(this.t1V,this.t2V,nM,this.t1Vec,this.t2Vec);
	...
	var LinConstraint = (function(){
		...
		ret.prototype.calcPre=function(){
			...
			Constraint.calcEfficM(m,this.obj1,this.pos1,this.obj2,this.pos2);
	...
	var Joint = (function(){
		...
		ret.prototype.setConstraint=function(){
			...
			Vec3.mul(this.linConstraint.offset,this.linConstraint.offset,0.2/_dt);
