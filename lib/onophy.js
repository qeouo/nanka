					...
					case SPHERE:
						...
						while(hitflg){
							...
							for(j = faces.length;j--;){
								face = faces[j]
								p0=vertices[face.idx[0]]
								p1=vertices[face.idx[1]]
								p2=vertices[face.idx[2]]
								
								Vec3.sub(bV1,p1.pos,p0.pos);
								Vec3.sub(bV2,p2.pos,p0.pos);
								Vec3.cross(bV3,bV1,bV2);
								Vec3.norm(bV3);
								
								Vec3.cross(bV4,bV3,bV1);
								Vec3.norm(bV4);
								Vec3.mul(bV4,bV4,1.0/Vec3.dot(bV2,bV4));
								
								Vec3.cross(bV5,bV2,bV3);
								Vec3.norm(bV5);
								Vec3.mul(bV5,bV5,1.0/Vec3.dot(bV1,bV5));
								
								Vec3.sub(bV1,p0.pos,bV0);
								var l=Vec3.dot(bV1,bV3);
								if(l*l>1.0){
									continue;
								}
								l=Vec3.dot(bV4,bV1);
								...
								l=Vec3.dot(bV4,bV3);
								Vec3.muladd(Geono.sPoint2,bV0,bV3,Vec3.dot(bV3,bV1));
