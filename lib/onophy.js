...
var OnoPhy = (function(){
	...
	ret.prototype._registHitInfo = (function(){
		...
		return function(nVec,obj1,pos1,obj2,pos2){
			...
			Vec3.copy(hitInfo.pos1,Vec3.ZERO);
	...
	ret.prototype.calc=function(dt){
		...
		for(var i=0;i<joints.length;i++){
			var joint = joints[i];
			var phyObj1 = joint.object1;
			var phyObj2 = joint.object2;
			
			var m = phyObj1.matrix;


			Mat44.dot(bM,phyObj2.matrix,joint.matrix);
			Vec3.set(n2,bM[12],bM[13],bM[14]);
			Mat44.dot(bM,phyObj1.inv_matrix,bM);
			...
			Mat44.dotMat44Vec3(n,phyObj1.matrix,n);
			Vec3.sub(n3,n2,n);
			var hI=this._registHitInfo(n3,phyObj1,n,phyObj2,n2);
