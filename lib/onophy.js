...
var OnoPhy = (function(){
	...
	var PhyObj = (function(){
		var PhyObj = function(){
			...
			this.inertiaTensor_=new Mat33(); //慣性テンソル
		...
		ret.prototype.calcPre = function(){
			...
			Mat33.dot(this.inertiaTensor,this.inertiaTensor_,bM);
		...
		ret.prototype.refresh = function(){
			...
			Mat33.mul(this.inertiaTensor_,this.inertiaTensor_,0);
			switch(type){
			case Collider.CAPSULE:
			case Collider.CYLINDER:
				var a =Math.max(sx,sy);
				var l = sz*2;
				var xy=this.mass*(a*a/4.0 + l*l/12.0);
				var z=this.mass*1/2*a*a;
				this.inertiaTensor_[0]=xy;
				this.inertiaTensor_[4]=xy;
				this.inertiaTensor_[8]=z;
			...
			case Collider.CUBOID:
				...
				this.inertiaTensor_[0]=x;
				this.inertiaTensor_[4]=y;
				this.inertiaTensor_[8]=z;
				Vec3.set(this.inertia,x,y,z);
				break;
			case Collider.CONE:
				var r = Math.max(sx,sy);
				var xy=3/80*this.mass*(4.0*r*r + 4*sz*sz);
				var z=3/10*this.mass*r*r;
				this.inertiaTensor_[0]=xy;
				this.inertiaTensor_[4]=xy;
				this.inertiaTensor_[8]=z;
				Vec3.set(this.inertia,xy,xy,z);
			...
			case Collider.CONVEX:
				...
				for(var i=0;i<faces.length;i++){
					...
					Mat33.add(this.inertiaTensor_,this.inertiaTensor_,I);
				}
				Vec3.mul(this.offset,P,1/Ssum );
				//Vec3.mul(this.offset,P,0 );
				Mat33.mul(this.inertiaTensor_,this.inertiaTensor_,this.mass/Ssum );
				var x =this.offset[0];
				var y =this.offset[1];
				var z =this.offset[2];
				I[0] = y*y+z*z;
			...
			default:
				...
				this.inertiaTensor_[0]=i;
				this.inertiaTensor_[4]=i;
				this.inertiaTensor_[8]=i;
				break;
			}
			...
			if(this.fix===1){
				...
				Vec3.set(this.inertia,i,i,i);
				Mat33.mul(this.inertiaTensor_,this.inertiaTensor_,0);
				this.inertiaTensor_[0]=99999;
				this.inertiaTensor_[4]=99999;
				this.inertiaTensor_[8]=99999;
			}
		}
