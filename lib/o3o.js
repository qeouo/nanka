...
var O3o=(function(){
	...
	ret.drawObject = function(obj,physics,renderEnvironment){
		var o3o = obj.o3o;
		...
		if(obj.type=="MESH"){
			drawObject(o3o,obj,physics,renderEnvironment);
		}
	}
	...
	var drawObject = function(o3o,obj,physics,renderEnvironment){
		...
		for(var i=0;i<bufMesh.faceSize;i++){
			...
			for(var j=0;j<face.idxnum-2;j++){
				...
				renderFace.environment = renderEnvironment;
