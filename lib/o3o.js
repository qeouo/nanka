...
var O3o=(function(){
	...
	var setEnvironment=function(environment,name){
		var i=0;
		for(;i<ono3d.renderEnvironments_index;i++){
			if(ono3d.renderEnvironments[i].name === name){
				return ono3d.renderEnvironments[i];
			}
		}
		var renderEnvironment= ono3d.renderEnvironments[i];
		ono3d.renderEnvironments_index++;

		renderEnvironment.envTexture=environment.envTexture;
	...
	ret.drawObject = function(obj,physics){
		...
		defaultEnvironment.envTexture = ono3d.envTexture;
		environment = setEnvironment(defaultEnvironment,"defaultEnvironment");
