...
//					setdata(dstobj,src[member]);
	...
	var calcEnv=function(renderVertex,vertex,environment,ratio){
		...
		for(var k=0;k<4;k++){
			...
			var r=ratio[k];
			//Vec3.madd(colx,colx,colorss[ox],r);
			//Vec3.madd(coly,coly,colorss[oy],r);
			//Vec3.madd(colz,colz,colorss[oz],r);
...
//		Vec3.mul(color,colx,ratiox);
//		Vec3.madd(color,color,coly,ratioy);
//		Vec3.madd(color,color,colz,ratioz);
	}
