...
var O3o=(function(){
	...
	var drawObject = O3o.drawObject = function(o3o,obj,physics){
		...
		if( ono3d.rf  & Ono3d.RF_OUTLINE){
			...
			renderMaterial.r = ono3d.outlineColor[0];
			renderMaterial.g = ono3d.outlineColor[1];
			renderMaterial.b = ono3d.outlineColor[2];
			renderMaterial.a = ono3d.outlineColor[3];
			renderMaterial.opacity = ono3d.outlineColor[3];
...
//			object=phyObjs[j].target;
	...
	var initPhyObj=O3o.initPhyObj=function(scene,phyObj){
		var i,imax,j;
		var objects = scene.objects;
		var object;
		var phyName,phyObj;
	...
	O3o.movePhyObj=function(scene,phyObj){
		var i,imax,j,jmax;
		var objects = scene.objects;
		var object;
		var phyName,phyObj;
