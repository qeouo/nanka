...
var h=[ 151,160,137,91,90,15,
   ...
   138,236,205,93,222,114,67,29,24,72,243,141,128,195,78,66,215,61,156,180
	...
	var _2root3 = 2/Math.sqrt(3);
	ret.simplenoise = function(x,y,z){
	  var y2 = y*_2root3;
		var x2 = x+y2*0.5
	  var z2 = z;
	  var r1,r2,r3;
	  ...
	  if(x2-(x2|0)>y2-(y2|0)){
			r1 = (x2-(x2|0))
			r2 = y2-(y2|0)
		  v1 =  hash256(x2|0,y2|0,z2|0);
		  v2 =  hash256(x2+1|0,y2+1|0,z2|0);
		  v3 =  hash256(x2+1|0,y2|0,z2|0);
		  r3 = r1 -r2;
		  ...
		  v1 =  hash256(x2|0,y2|0,z2|0);
		  v2 =  hash256(x2+1|0,y2+1|0,z2|0);
		  v3 =  hash256(x2|0,y2+1|0,z2|0);
		  r3 = -r1 +r2;
		  
			r2 = (x2-(x2|0))
			r1 = 1-(y2-(y2|0))
	  }
		var v = lerp(fade((r2)/(r1+r2),v1,v2));
	  r3 = 1-fade(r1+r2);
	  v = lerp(fade(r3),v,v3);

	//   v = lerp(v1,v2,((r1+r2)/2));
	 // v = lerp(v,v3,(r3));

	  v = v1*r1 + v2*r2 + v3 *(1-r1-r2)
