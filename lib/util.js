...
var Util=(function(){
	...
	ret.loadFile=function(file,callback,callback2){
		var reader=new FileReader();
		reader.onload=function(e){
...
var DataStream =(function(){
	var DataStream =function(arraybuffer,offset,length){
		...
		if(typeof arraybuffer === "number"){
			this.byteBuffer=new Uint8Array(buffer);
			...
			if(length){
				this.byteBuffer=new Uint8Array(buffer,offset,length);
				this.dv=new DataView(this.byteBuffer.buffer,offset,length);
			}else{
				this.byteBuffer=new Uint8Array(buffer);
				this.dv=new DataView(this.byteBuffer.buffer);
			}
