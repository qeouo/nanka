...
var Ono3d = (function(){
	...
	ret.prototype= {
		...
		,init:function(_canvas,_ctx){
			...
			compositionshader = Ono3d.loadShader("compositionshader",currentpath+"webgl/add.js")
	...
	ret.prototype.render = function(shadowTex,camerap,customMaterial){
		...
		if(customMaterial){
			...
			//合成
			var addShader = compositionshader;
