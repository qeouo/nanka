...
var Ono3d = (function(){
	...
	ret.prototype= {
		...
		,init:function(_canvas,_ctx){
			...
			var filenames=["add","average","average2","average3","fill","glass","main","test","decode","shadow","plain","n1s","n2s","cube2polar","rough","celestialsphere"];
...
//シャドウマップ描画
		...
		if(customMaterial){
			...
			if(idx>=0){
				...
				Rastgl.postEffect({gltexture:Rastgl.fTexture},0,0 ,i32a[2]/1024,i32a[3]/1024,addShader); 
