...
var Ono3d = (function(){
	...
	ret.prototype= {
		...
		,init:function(_canvas,_ctx){
			...
			var filenames=["add","average","average2","average3","fill","glass","main","test","decode","shadow","plain","n1s","n2s","cube2polar","rough","celestialsphere","envset","gauss","normal","cube2lightfield"];
...
var calcST = function(s,t,p0,p1,p2,u0,v0,u1,v1,u2,v2){
	...
	ret.prototype.createCubeMap= function(image,x,y,z,size,func){
		...
		Ono3d.drawCopy(0,0,1,1,image,0,y,1.0,-y);
