	...
	ret.prototype.renderShader=function(start,size,customMaterial,envIdx){
		...
		while(i<start+size){
			...
			if(j>i){
				...
				gl.uniform4f(unis["uPbr"],material.metalness,material.roughness,material.subRoughness,material.ior);
