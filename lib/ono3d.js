...
var calcST = function(s,t,p0,p1,p2,u0,v0,u1,v1,u2,v2){
	...
	ret.prototype.createLightField= function(tex,x,y,z,func){
		var size = 32;
		if(!tex){
	...
	//	Ono3d.copyImage(tex,0,0,0,0,size*4,size*2);
		var texsize=size;
