...
var Ono3d = (function(){
	...
	ret.prototype= {
		...
		,init:function(_canvas,_ctx){
			...
			this.shaders=[];
			var t=this;
			this.loadShader("mainshader",currentpath+"webgl/mains.shader")

			this.loadShader("testshader",currentpath+"webgl/test.shader");
			this.loadShader("glassshader",currentpath+"webgl/glass.shader");
			   
			Util.loadJs(currentpath+"webgl/decode.js");
		}
	...
	ret.loadPostShader=function(name,vs,fs){
		var atts=["aPos"];
		var unis=[ "uPosScale", "uPosOffset", "uUvScale", "uUvOffset","uSampler","uSampler2"];
...
var calcST = function(s,t,p0,p1,p2,u0,v0,u1,v1,u2,v2){
	...
	ret.prototype.loadShader=function(name,path){
		var t = this;
		Util.loadText(path,function(txt){
			var vs=txt.match(/\[vertexshader\]([\s\S]*)\[fragmentshader\]([\s\S]*)/);
			vs[2]=vs[2].replace("[common]",Rastgl.commonFunction + Rastgl.textureRGBE);
			...
			var	shader = Ono3d.createShader(name,vs[1],vs[2],atts,unis);
