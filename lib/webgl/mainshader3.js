...
void main(void){ \
	...
	refCol02 = texture2D(uTransparentmap,refV*refx*0.5 + vec2(0.0,1.0-refx*0.5)); \
	refCol02.rgb *= (refCol02.a * 3.0 + 1.0); \
	transCol.rgb = mix(transCol.rgb,refCol02.rgb,refa) * uColor.xyz; \
	/*乱反射強度*/ \
	vec3 light; \
	...
	/*透過合成*/ \
	vColor2 = mix(vColor2,transCol,1.0 - uOpacity); \
	/*全反射合成*/ \
