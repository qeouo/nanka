...
void main(void){ \
	float reflectPower = uPBR.x; \
	float rough = uPBR.y; \
	float transRough = uPBR.z; \
	float refractPower = uPBR.w; \
...
ret.draw=function(ono3d,shadowTex,env2dtex,camerap,frenel){
	...
	var posindex=args["aPos"].offset2*jsize;
	var normalindex=args["aNormal"].offset2*jsize;
	var sindex=args["aSvec"].offset2*jsize;
	var tindex=args["aTvec"].offset2*jsize;
	var uvindex=args["aUv"].offset2*jsize;
	...
	for(var i=0;i<arrlength;i++){
		...
		buff[posindex]=vertex.pos[0]
		buff[posindex+1]=vertex.pos[1]
		buff[posindex+2]=vertex.pos[2]
		buff[normalindex+posindex]=vertex.normal[0] * smoothing + nx
		buff[normalindex+posindex+1]=vertex.normal[1] * smoothing + ny
		buff[normalindex+posindex+2]=vertex.normal[2] * smoothing + nz
		posindex+=3;
		...
		buff[uvindex]=renderface.uv[0][0]
		buff[uvindex+1]=renderface.uv[0][1]
		buff[uvindex+2]=renderface.uv[1][0]
		buff[uvindex+3]=renderface.uv[1][1]
		buff[uvindex+4]=renderface.uv[2][0]
		buff[uvindex+5]=renderface.uv[2][1]
		...
		buff[sindex+posindex-9]=svec[0]
		buff[sindex+posindex-9+1]=svec[1]
		buff[sindex+posindex-9+2]=svec[2]
		buff[sindex+posindex-9+3]=svec[0]
		buff[sindex+posindex-9+4]=svec[1]
		buff[sindex+posindex-9+5]=svec[2]
		buff[sindex+posindex-9+6]=svec[0]
		buff[sindex+posindex-9+7]=svec[1]
		buff[sindex+posindex-9+8]=svec[2]
		buff[tindex+posindex-9]=tvec[0]
		buff[tindex+posindex-9+1]=tvec[1]
		buff[tindex+posindex-9+2]=tvec[2]
		buff[tindex+posindex-9+3]=tvec[0]
		buff[tindex+posindex-9+4]=tvec[1]
		buff[tindex+posindex-9+5]=tvec[2]
		buff[tindex+posindex-9+6]=tvec[0]
		buff[tindex+posindex-9+7]=tvec[1]
		buff[tindex+posindex-9+8]=tvec[2]
...
var render = function(ono3d,shadowTex,env2dtex,camerap,frenel,opFlg){
	...
	Rastgl.useProgram(shader,arr.length*3);

	var i=0;
	var arrlength=arr.length;
	var materialIndex;
	Rastgl.useProgram(shader,arrlength*3);
	while(i<arrlength){
		...
		if(material.normalmap){
			...
			gl.uniform1i(args["uNormalMap"],3);
