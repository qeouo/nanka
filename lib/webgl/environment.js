...
//	col.r = (col.r<0.5)?col.r*2.0:col.r*10.0 -4.0; \
//	col.g = (col.g<0.5)?col.g*2.0:col.g*10.0 -4.0; \
//	col.b = (col.b<0.5)?col.b*2.0:col.b*10.0 -4.0; \
//	col.a =  col.a; \
//	gl_FragColor= mix( vColor * colA \
//		,vColor * col \
//		,vColor.w); \
//	gl_FragColor.w=1.0; \
//} \
...
void main(void){ \
 ...
 \
	...
	col = color / float(MAX); \
	gl_FragColor.r = (col.r<1.0)?col.r*0.5:col.r*0.1 +0.4; \
	gl_FragColor.g = (col.g<1.0)?col.g*0.5:col.g*0.1 +0.4; \
	gl_FragColor.b = (col.b<1.0)?col.b*0.5:col.b*0.1 +0.4; \
