...
void main(void){ \
	...
	refCol.rgb = refCol.rgb * (4.0 -refCol.a * 3.0) * uReflectionColor; \
	angle = eye + dot(eye,nrm)* ( uRefract -1.0) * nrm; \
	vec4 refCol2 = textureCube(uReflectmap,angle); \
	refCol2.rgb = refCol2.rgb  * (4.0 -refCol2.a * 3.0) * uColor.rgb; \
	vec3 light; \
	...
	light = light +uEmi; \
	vec4 vColor2 = vec4(uColor.xyz * light *clamp(vFar,0.,1.),uOpacity); \
