...
var MainShader=(function(){
	return Ono3d.loadShader("mainshader"," \
...
void main(void){ \
	...
	refV = gl_FragCoord.xy/1024.0+angle.xy*(1.0-refractPower)*0.02; \
	vec4 transCol = (textureRGBE(uTransMap,texsize,refV*refx + vec2(0.0,1.0-refx))); \
	q = (textureRGBE(uTransMap,texsize, refV*refx*0.5 + vec2(0.0,1.0-refx*0.5))); \
