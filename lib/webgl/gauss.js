...
void main(void){ \
	...
	col += texture2D(uSampler,(fc+scale*-4.))*weight[4]; \
	col += texture2D(uSampler,(fc+scale*-3.))*weight[3]; \
	col += texture2D(uSampler,(fc+scale*-2.))*weight[2]; \
	col += texture2D(uSampler,(fc+scale*-1.))*weight[1]; \
	col += texture2D(uSampler,(fc+scale*-0.))*weight[0]; \
	col += texture2D(uSampler,(fc+scale*1.))*weight[1]; \
	col += texture2D(uSampler,(fc+scale*2.))*weight[2]; \
	col += texture2D(uSampler,(fc+scale*3.))*weight[3]; \
	col += texture2D(uSampler,(fc+scale*4.))*weight[4]; \
...
<<<<<<< HEAD
	gl.uniform1f(args["scale2"],scale2);
=======
