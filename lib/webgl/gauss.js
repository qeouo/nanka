...
ret.filter=function(dst,src,d,scale,width,height){
...
for(i = 0; i < weight.length; i++){
	...
	gl.uniform1f(args["uScale"],scale);
	gl.uniform2f(args["scale2"],1/width,1/height);
